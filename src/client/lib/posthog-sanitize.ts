...
// Full MCP API keys look like oseo_ + high-entropy secret (see API_KEY_PREFIX
// in src/lib/auth-api-key.ts). Prefix-only UI display values (e.g. "oseo_abcd")
// are shorter and left alone.
