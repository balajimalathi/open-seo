...
export const whoamiTool = {
  ...
  config: {
    title: "Who am I",
    description:
      "Returns the authenticated user, organization, server mode, and token scopes. Uses no credits — does not call DataForSEO. Use this first to confirm connection context before choosing a project or running tools.",
  ...
  handler: async (_args: Record<string, never>, context: ToolContext) => {
    ...
    // OpenSEO usage credits are disabled; balance lives on the DataForSEO account.
